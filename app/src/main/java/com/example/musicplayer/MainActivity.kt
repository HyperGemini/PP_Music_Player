...
class MainActivity : AppCompatActivity() {
    ...
    var songModelModelData: ArrayList<SongModel> = ArrayList() //Niz pesama
    ...
    fun loadData(){
        ...
        //obilazak MediaStora (izvlacenje pesama)
        ...
        viewAdapter = ViewAdapter(songName,playPause,next,previous,loop,shuffle,curTime,totTime,seekBar,playPausePrim,songNamePrim)
